		...
		<div id="openid-connect-authenticate">
			<div id="openid-connect-authenticate-form-container" class="login">
				<form class="wp-core-ui">
					...
					<br/>
					<p><?php echo __( "You don't have permission to use OpenID Connect.", 'wp-openid-connect-server' ) ?></p>
					<br/>
					<p><?php echo __( "Contact your administrator for more details.", 'wp-openid-connect-server' ) ?></p>
					<br/>
					<p class="submit">
						<a class="button button-large" href="<?php echo esc_url( $data['cancel_url'] ); ?>"
						   target="_top">
		...
		<div id="openid-connect-authenticate">
			<div id="openid-connect-authenticate-form-container" class="login">
				<form method="post" action="<?php echo esc_url( $data['form_url'] ); ?>" class="wp-core-ui">
					...
					<?php endforeach; ?>
					<p class="submit">
						<input type="submit" name="authorize" class="button button-primary button-large"
							   value="<?php esc_attr_e( 'Authorize', 'wp-openid-connect-server' ); ?>"/>
